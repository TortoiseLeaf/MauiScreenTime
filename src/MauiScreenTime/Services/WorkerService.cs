...
namespace MauiScreenTime.Services
{
    internal class WorkerService : IWorkerService
    {
        ...
        public WorkerService(ICO2Service co2Service, IAppUsageDatabase appUsageDatabase, IUsageStatsService usageStatsService, IUserActivityLogDatabase userActivityLogDatabase)
        {
        ...
        {
            System.Diagnostics.Debug.WriteLine($"Fires: Workerservice");
            ...
            try
            {
                ...
                System.Diagnostics.Debug.WriteLine("Fires: RunDailyTask saved to db completed");
